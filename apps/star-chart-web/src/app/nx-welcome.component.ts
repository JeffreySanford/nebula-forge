      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build star-chart-web
<span># Test</span>
nx test star-chart-web
<span># Lint</span>
nx lint star-chart-web
<span># Run them together!</span>
nx run-many -p star-chart-web -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project star-chart-web</pre>
          </details>
